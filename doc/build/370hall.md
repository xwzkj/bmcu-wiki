...
将两个`0.8*12*25弹簧`放入滑块两端，卡在滑块安装位内（图中我为了演示临时使用了370钢珠版用的0.7*12*30弹簧，安装较为困难，必须扶着才不会飞出来）
...
**该步骤较为困难，多加尝试** 将中框扣在后盖上，滑块有磁铁的那部分是要穿过中框的
