...
群内提问提供完整的图片和描述,比如**PCB&外壳&固件版本+全部灯光状态+焊接工具/物料发货单[可选]**
:::
...
注：**文章下面还有孔明写的该问题方案，懒得合并了，如果以上操作未解决问题，可以去下面看**
...
如果同时有进料暴力、打印频繁冲刷、无限退料直到超时三种现象，但磁铁能检测到也能跟着转，可能是BMG轴太高导致安装电路板后将磁铁顶在5600芯片上无法转动
...
极有可能是通讯原件受损，或者`CH32V203C8T6`主控芯片受损，可以通过排除法来检测问题所在，即使用新的原件换上，这种情况极有可能是焊接问题导致，注意焊接方式以及温度是否控制得当
...
![霍尔主板去二极管](/assets/debug/霍尔主板去二极管.png)

丸子注：**无论如何不提倡热插拔，一切损失由您自行承担**

### 主板上焊接时，过高高温容易损坏一些原件

1. WS2812B led灯
2. TP75176E-SR通讯芯片（会导致可能烧录成功但连接打印机失败的现象）
3. CH32V203C8T6主控芯片（相对来说比较耐高温，但不能高温时间太长）
4. br开关的微动开关
5. 卧贴PH2.0座子
...
如果使用了干燥箱，可以尝试更换气动头优化阻力。DIY最常用的PC4-M6气动接头尾部的孔比较小，对PLA等表面不够光滑的材料会造成很大阻力，可以更换为贯穿的气动头，让铁氟龙管穿过气动接头进入干燥箱。
