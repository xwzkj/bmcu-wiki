...
2 使用部分具有吸锡的工具，检查组排或者ch302主控，去除过多的焊锡
3 检查b，r微动开关是否焊接成功，或者检查按动效果是否正常，部分用户喜欢加入热板或者热风枪等工具，高温会烫坏开关
4 可能ch302主控损坏，建议更换一颗

其中例如在上机实测后，**刚连接bmcu就发现某个通道疯狂转**，就极有可能是ch302主控原因，还有部分通道可能**光电不能识别或者常亮**也是有可能和ch302有关，你可以把ch302想象成大脑，身体任何地方出现问题都会有概率和他有关，当然，也有可能是主板其他地方有短路或者虚焊等现象导致

其中注意，烧录成功并不一定代表ch302主控就没有任何问题，烧录成功只能说明你有几根针脚焊接无误，并不代表整体完好
...
1 led灯
2 75开头的八角通讯芯片（会导致可能烧录成功但连接打印机失败的现象）
3 ch302主控芯片（相对来说比较耐高温，但不能高温时间太长）
4 br开关的微动开关
5 卧贴10p子座
