...
另有群友`@白小淘`制作的`180电机版`，属于特殊的`130电机版`，旨在解决130电机不易购买的问题，固件与结构和130版一致，以及 由`@星尘`进行更多改动的`BMCU370x`贴片微动版本，这个版本仍然保持兼容原版。
...
该版本结构简单，电机易于购买，但由于尚未结束设计，资料较少，该电机是P1系列打印机的前提，因130电机稳定且缓慢，会导致送料失败。
