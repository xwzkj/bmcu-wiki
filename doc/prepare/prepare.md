...
130版(BMCU-A)是较早版本，目前主要缺点是电机不太好买，结构调试较为复杂

370版包含(B与C)，其中B完全不推荐，存在爆五通问题。C是霍尔版本，调试难度与使用效果平衡极好，首推。
...
:::tip
推荐采用[材料清单](./list.md)页面的链接下单，已经选好了数量和详细规格，**第三方改版的物料需要自行检查区别**（此可能文档年久失修，如遇涨价商品自行斟酌）
:::
...
| CH340 USB转TTL模块            | 必备(吧)   | 用于固件烧录，40V版本无需，内置CH340版本也无需              |
