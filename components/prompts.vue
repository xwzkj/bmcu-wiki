    ...
    if (preStatus?.websitesV1 < 5 || true) {
        notification.create({
            ...
            content: () => h('div', { class: 'vp-doc' },
                [
                    '\n  丸子因学业暂停wiki维护，欢迎大家',
                    h('a', { href: '/doc/prepare/what-is-it.html#%E8%B4%A1%E7%8C%AE%E9%A1%BB%E7%9F%A5', target: '_blank' }, '进行贡献'),
                    '（务必遵守贡献须知！）。',
                    h('span', { style: { color: 'red' } }, '目前本站完全由社区pr维护，不保证准确性，且更新频率较低，请自行根据页面底部“最后更新于”判断时效性！'),
                    '\n\n  目前源站为github pages，并使用cloudflare cdn。',
